...
public class MergeDuplicateCOCA {
	...
	public static void main(String[] args) {
		...
		String cocaFile = Constant.PATH_RESOURCES + "/美国当代英语语料库COCA词频20000_words.txt";
		// 1.读取加载coca文件
...
//					isAdd = false;
//					String newWordLine = wordLine[0] + "/" + fileLine[0] + "\t" + wordLine[1] + "\t" + wordLine[2] + "/"
//							+ fileLine[2];
...
//		}
		...
		// 3.保存word list
		String cocaWordFile = Constant.PATH_RESOURCES + "/美国当代英语语料库COCA词频20000_words_unique.txt";
