...
import com.myblog.filter.FileExtNameFilter;
...
public class FileUtil {
	 ...
	 * @return
	 */
	public static final int countPics(String path,String id, String dtime, String extensions) {
		int counts = 0;

		FileExtNameFilter mfilter = new FileExtNameFilter(extensions.split(","));
