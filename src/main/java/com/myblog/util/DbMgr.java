...
//	private static final String DB_NAME = "LevelWordDB2.db3"; // "c:/testDB.db3";//数据库名称
...
//			// 2.建立数据库连接
//			Conn = DriverManager.getConnection(dbUrl + DB_NAME, dbUser, dbPwd);
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		return Conn;
...
//	 *             SQL异常
//	 */
//	public static int insertAll(String tableName,
//			List<Map<String, Object>> datas) throws SQLException {
//		/** 影响的行数 **/
...
//					preparedStatement.setObject(k + 1, datas.get(j)
//							.get(keys[k]));
//				}
...
//		String sql = buildQueryString(distinct, tableName, columns, selection,
...
//	 */
//	private static String buildQueryString(boolean distinct, String tables,
...
//
//	/**
//	 * After the execution of the complete SQL statement, not necessarily the
//	 * actual implementation of the SQL statement
//	 * 
//	 * @param sql
//	 *            SQL statement
//	 * @param bindArgs
